...
@section('content')
    ...
    <div class="wrapper-md">
        <form class="row" role="form" action="{{URL::route('dashboard.modals.update',$modal->id)}}" method="post"
            ...
            <div class="col-sm-8">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                                    ...
                                    <textarea class="textarea textareaedit form-control" name="body" rows="30">
                                        {!! $modal->body or '' !!}
                                    </textarea>
