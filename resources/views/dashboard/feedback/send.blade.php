                        ...
                        <form method="post" action="{{URL::route('dashboard.feedback.store')}}">
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    <input class="form-control" name="email" required placeholder="Кому:"
                                           value="{{ $Feedback->email or '' }}"/>
                                </div>
                                <div class="form-group">
                                    <input class="form-control" name="theme" required placeholder="Тема:"/>
                                </div>
                                <div class="form-group">
                    <textarea class="form-control textarea textareaedit" required name="contentmess"
                              style="height: 400px">
                                ...
                                <div class="box-footer">
                                    ...
                                    <a href="/dashboard/feedback/">
                                        <button class="btn btn-default"><i class="fa fa-times"></i> Отмена</button>
                                    </a>
                                </div>
                                <!-- /.box-footer -->
                            </div>
