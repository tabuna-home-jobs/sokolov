                                        ...
                                        <div id="wpcontent">
                                            <div id="wpbody">
                                                    ...
                                                    <div class="wrap">
                                                        <div class="manage-menus">
                                                            <form method="get" action="{{route('wmenuindex')}}">
                                                                <label for="menu" class="selected-menu">Выберите меню
                                                                    для редактирования:</label>
                                                ...
                                                <input type="submit" class="btn btn-primary" value="Изменить">
                                                                ...
                                                                <span class="add-new-menu-action"> или <a
                                                                            href="{{route('wmenuindex')}}?action=edit&menu=0">Создать
                                                                        новое меню</a>. </span>
                                                            </form>
                                                        </div>
                                                                            ...
                                                                            <ul class="outer-border">
                                                                                <li class="control-section accordion-section  open add-page"
                                                                                    ...
                                                                                    <h3 class="accordion-section-title hndle"
                                                                                        tabindex="0"> Добавить ссылку
                                                                                        <span class="screen-reader-text">Пресс возвращение или введите расширить</span>
                                                                                    </h3>
                                                                                            ...
                                                                                            <div class="customlinkdiv"
                                                                                                ...
                                                                                                <p class="button-controls">
                                                                                                    ...
                                                                                                    <a href="#"
                                                                                                       ...
                                                                                                       class="button-secondary submit-add-to-menu right">Добавить
                                                                                                        новый элемент
                                                                                                        меню</a>
                                                                                                    <span class="spinner"
                                                                                                          id="spincustomu"></span>
                                                                                    ...
                                                                                    @if(Input::has('action'))
                                                                                        <div class="publishing-action">
                                                                                            <a onclick="createnewmenu()"
                                                                                               name="save_menu"
                                                                                               id="save_menu_header"
                                                                                               class="btn btn-primary menu-save">Создать
                                                                                                меню</a>
                                                                                        </div>
                                                                                    @elseif(Input::has("menu"))
                                                                                        <div class="publishing-action">
                                                                                            <a onclick="getmenus()"
                                                                                               name="save_menu"
                                                                                               id="save_menu_header"
                                                                                               class="btn btn-primary menu-save">Сохранить
                                                                                                меню</a>
                                                                                        </div>
                                                                                    ...
                                                                                    @else
                                                                                        <div class="publishing-action">
                                                                                            <a onclick="createnewmenu()"
                                                                                               name="save_menu"
                                                                                               id="save_menu_header"
                                                                                               class="btn btn-primary menu-save">Create
                                                                                                menu</a>
                                                                                        </div>
                                                                                    @endif
                                                                                </div>
                                                                                                    ...
                                                                                                    <dl class="menu-item-bar">
                                                                                                        <dt class="menu-item-handle">
                                                                                                            <span class="item-title"> <span
                                                                                                                        ...
                                                                                                                        |</span> </span> <span
                                                                                                                        class="is-submenu"
                                                                                                                        style="@if($m->depth==0)display: none;@endif">Подъелемент</span> </span>
                                                                                                            <span class="item-controls"> <span
                                                                                                                        class="item-type">Ссылка</span> <span
                                                                                                                        class="item-order hide-if-js"> <a
                                                                                                                            href="{{route('wmenuindex')}}?action=move-up-menu-item&menu-item={{$m->id}}&_wpnonce=8b3eb7ac44"
                                                                                                                            class="item-move-up"><abbr
                                                                                                                                title="Move Up">↑</abbr></a> | <a
                                                                                                                            href="{{route('wmenuindex')}}?action=move-down-menu-item&menu-item={{$m->id}}&_wpnonce=8b3eb7ac44"
                                                                                                                            class="item-move-down"><abbr
                                                                                                                                title="Move Down">↓</abbr></a> </span> <a
                                                                                                                        class="item-edit"
                                                                                                                        id="edit-{{$m->id}}"
                                                                                                                        title=" "
                                                                                                                        href="{{route('wmenuindex')}}?edit-menu-item={{$m->id}}#menu-item-settings-{{$m->id}}"> </a> </span>
                                                                                                        </dt>
                                                                                                    </dl>
                                                                                                    ...
                                                                                                    <div class="menu-item-settings"
                                                                                                        ...
                                                                                                        <p class="field-move hide-if-no-js description description-wide">
                                                                                                            <label>
                                                                                                                ...
                                                                                                                <a href="{{route('wmenuindex')}}?action=edit&menu=26#"
                                                                                                                   class="menus-move-up"
                                                                                                                   style="display: none;">Вверх</a>
                                                                                                                <a href="{{route('wmenuindex')}}?action=edit&menu=26#"
                                                                                                                   class="menus-move-down"
                                                                                                                   title="Mover uno abajo"
                                                                                                                   style="display: inline;">В
                                                                                                                    низ</a>
                                                                                                                <a href="{{route('wmenuindex')}}?action=edit&menu=26#"
                                                                                                                ...
                                                                                                                <a href="{{route('wmenuindex')}}?action=edit&menu=26#"
                                                                                                                   ...
                                                                                                                   style="display: none;">Верх</a>
                                                                                                            </label>
                                                                                                        </p>

                                                                                                        <div class="menu-item-actions description-wide submitbox">

                                                                                                            <a class="item-delete btn btn-danger"
                                                                                                               id="delete-{{$m->id}}"
                                                                                                               href="{{route('wmenuindex')}}?action=delete-menu-item&menu-item={{$m->id}}&_wpnonce=2844002501">Удалить</a>
                                                                                                            <a class="item-cancel hide-if-no-js btn btn-link"
                                                                                                               id="cancel-{{$m->id}}"
                                                                                                               href="{{route('wmenuindex')}}?edit-menu-item={{$m->id}}&cancel=1424297719#menu-item-settings-{{$m->id}}">Отмена</a>
                                                                                                            <a onclick="updateitem({{$m->id}})"
                                                                                                               class="btn btn-primary updatemenu"
                                                                                                               id="update-{{$m->id}}"
                                                                                                               href="javascript:void(0)">Обновить
                                                                                                                элемент</a>
                                                                                ...
                                                                                <div class="major-publishing-actions">
                                                                                    ...
                                                                                    @elseif(Input::has("menu"))
                                                                                        <span class="delete-action"> <a
                                                                                                    ...
                                                                                                    onclick="deletemenu()"
                                                                                                    href="javascript:void(9)">Удалить
                                                                                                меню</a> </span>
                                                                                        <div class="publishing-action">
                                                                                            <a onclick="getmenus()"
                                                                                               name="save_menu"
