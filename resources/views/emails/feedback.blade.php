...
<div id="mailsub" class="notification" align="center">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="min-width: 320px;"><tr><td align="center" bgcolor="#f7f7f7">
                ...
                <table border="0" cellspacing="0" cellpadding="0" class="table_width_100" width="100%" style="max-width: 680px; min-width: 300px;">
                    ...
                    <tr><td align="center" bgcolor="#ffffff">
                            <!-- padding --><div style="    line-height: 30px;
    font-size: 10px;
    background: url(/img/topline.png) 100% 100%;
    height: 12px;
    width: 100%;"> </div>
                            <table width="90%" border="0" cellspacing="0" cellpadding="0">
                                <tr><td align="left"><!--

				Item --><div class="mob_center_bl" style="float: left; display: inline-block; width: 100%;">
				...
				<span style="font-family: Arial, Helvetica, sans-serif; font-size: 13px; color: #96a5b5;">
					© 2015 - 2016 <br> Falcon Scientific Editing
				</span></font>
                                    </td></tr>
                            </table>
