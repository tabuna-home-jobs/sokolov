<form id="calculator-{{$id or  '0'}}" class="form-horizontal">
    ...
    <div class="form-group">
        <label for="words-{{$id or  '0'}}" class="col-sm-5 control-label">
            ...
            <small class="pull-left small-small"> {{trans('calc.exclude references and numbers in tables')}}</small>
    ...
    <div class="calc-button-{{$id or  '0'}}" style="display:none;">
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-8 text-center">
                <a href="/{{App::getLocale()}}/feedback">{{trans('calc.Outside your budget?')}}</a>
            </div>
        </div>
...
<script>
    ...
    $('input[name="words-{{$id or  '0'}}"]').change(function () {
        ...
        $('input[name="price-{{$id or  '0'}}"]').val(price);
