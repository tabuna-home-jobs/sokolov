...
return [
    ...
    'We employ only experienced scientific academic editors who are experts in a particular scientific field. All our editors - experts in English grammar, spelling and punctuation.' => 'Опытные научные академические редакторы, каждый из которых эксперт в конкретной научной области.',
    'Our scientific editors have extensive experience in prestigious academic research institutions. Our editors have a significant number of highly cited publications in scientific journals in English.' => 'Эксперты в английской грамматике, орфографии и пунктуации.',
    'Our scientific editors wrote, edited and reviewed scientific publications and grants.' => 'Имеют значительный опыт работы в престижных научных исследовательских учреждениях и ряд собственных научных публикаций.',
    'We know that you need to publish your important scientific discoveries in the English-language journal. The language barrier should never be a barrier to the spread of important ideas and discoveries! We are here to help you succeed!' => 'Знают, что необходимо для публикации ваших научных открытий в англоязычном научном журнале.',
    'If your research is not published - they never had. Many manuscripts are accepted for publication because of the poor quality of the English language. Our editors - experts in English. Our editors - scientific experts with many years of research and publications in prestigious scientific journals.' => 'Наши научные редакторы являються авторами, редакторами и рецензентами научных публикаций и грантов.',
    'We guarantee that your paper will not be rejected by the scientific journal of the poor quality of the English language. We re-edit your article - free of charge.' => 'Помогут вам добиться успеха в вашей научной деятельности!',
...
                             English' => 'Грамотный и оперативный технический перевод рукописей и других документов с русского на английский',
    ...
    'Fit manuscripts under strict
                             foreign scientific standards
                             magazines' => 'Выявление и исправление проблем c форматированием работ, не соответствующему требованиям Вашего целевого зарубежного издания',
    'illustrating' => 'Иллюстрирование',
...
                             description' => 'Изменение и создание уникальных и интересных иллюстраций, поясняющих графиков и таблиц, которые помогут вашей рукописи выделиться',
    ...
    'lastSlider' => 'Мы предоставляем услуги для профессоров, докторантов, аспирантов и всех интересующихся наукой людей.',

    'RELIABLE' => 'НАДЕЖНО',
    'RESPONSIBLY' => 'ОТВЕТСТВЕННО',
    'CONVENIENTLY' => 'УДОБНО',

    'RELIABLE TEXT' => 'Ваш текст гарантированно защищен от попадания в чужие руки.',
    'RESPONSIBLY TEXT' => 'Мы подходим к своей работе профессионально, если Ваша работа не принимается по причине некачественного английского языка — мы сделаем все необходимые поправки БЕСПЛАТНО! ',
    'CONVENIENTLY TEXT' => 'Окончательное решение относительно той или иной правки всегда за ВАМИ',

    'Your guarantees' => 'Ваши гарантии',

    'text-logo' => 'Редактирование научных работ, технический перевод с русского на английский, форматирование и иллюстрирование рукописей учеными для ученых',

    'subscription' => 'ПОДПИСАТЬСЯ',
    'subscription-text' => 'Получите советы по написанию и публикации Ваших работ!',
    'subscrption-email' => 'Впишите Вашу электронную почту',
    'subscription-success' => 'Успех',
    'subscription-success-text' => 'Вы удачно подписались на получение советов по написанию и публикации Ваших работ!',
