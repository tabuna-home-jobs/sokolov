...
return [
    ...
    "Next" => 'Далее',
    "Give a description of the available work" => "Дайте доступное описания работы",
    "Job title" => "Название работы",
    "Scientific publication, for which formats work" => "Научное издание, для которого подготавливается работа",
    "For what language translation needs" => "Желаемый стиль английского языка",
    "Download the required documents" => "Загрузите необходимые документы",
