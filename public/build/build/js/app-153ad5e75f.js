if (!function (t, e) {
        ...
        function x(t) {
            var e = K, n = Mt[t];
            return n || (n = b(t, e), "none" !== n && n || (qt = (qt || Z("<iframe frameborder='0' width='0' height='0'/>")).appendTo(e.documentElement), e = qt[0].contentDocument, e.write(), e.close(), n = b(t, e), qt.detach()), Mt[t] = n), n
        }

        function w(t, e, n) {
            var i, o, r, s, a = t.style;
            return n = n || Ut(t), n && (s = n.getPropertyValue(e) || n[e]), n && ("" !== s || Z.contains(t.ownerDocument, t) || (s = Z.style(t, e)), Bt.test(s) && Wt.test(e) && (i = a.width, o = a.minWidth, r = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = o, a.maxWidth = r)), void 0 !== s ? s + "" : s
        }
        ...
        function E(t, e, n) {
            ...
            if (0 >= o || null == o) {
                ...
                i = s && (J.boxSizingReliable() || o === t.style[e]), o = parseFloat(o) || 0
            }
        ...
        function O(t, e, n) {
            var i, o, r, s, a, l, c, u, h = this, p = {}, f = t.style, d = t.nodeType && Ct(t), g = vt.get(t, "fxshow");
            ...
            if (Z.isEmptyObject(p))"inline" === ("none" === c ? x(t.nodeName) : c) && (f.display = c); else {
                ...
                for (i in p)s = j(d ? g[i] : 0, i, h), i in g || (g[i] = s.start, d && (s.end = s.start, s.start = "width" === i || "height" === i ? 1 : 0))
            }
        }
        ...
        function L(t, e, n) {
            var i, o, r = 0, s = ee.length, a = Z.Deferred().always(function () {
                ...
                if (o)return !1;
                for (var e = Jt || D(), n = Math.max(0, c.startTime + c.duration - e), i = n / c.duration || 0, r = 1 - i, s = 0, l = c.tweens.length; l > s; s++)c.tweens[s].run(r);
        ...
        function M(t, e, n, i) {
            ...
            if (Z.isArray(e))Z.each(e, function (e, o) {
                n || $e.test(t) ? i(t, o) : M(t + "[" + ("object" == typeof o ? e : "") + "]", o, n, i)
        ...
        var B = [], U = B.slice, _ = B.concat, z = B.push, V = B.indexOf, Q = {}, X = Q.toString, Y = Q.hasOwnProperty, J = {}, K = t.document, G = "2.1.4", Z = function (t, e) {
        ...
        var ot = function (t) {
            function e(t, e, n, i) {
                ...
                if (!i && L) {
                    if (11 !== a && (o = yt.exec(t)))if (s = o[1]) {
                        ...
                        if ((s = o[3]) && w.getElementsByClassName)return G.apply(n, e.getElementsByClassName(s)), n
                    }
                    if (w.qsa && (!R || !R.test(t))) {
                        if (f = h = q, d = e, g = 1 !== a && t, 1 === a && "object" !== e.nodeName.toLowerCase()) {
                            for (c = k(t), (h = e.getAttribute("id")) ? f = h.replace(xt, "\\$&") : e.setAttribute("id", f), f = "[id='" + f + "'] ", l = c.length; l--;)c[l] = f + p(c[l]);
                            d = bt.test(t) && u(e.parentNode) || e, g = c.join(",")
                        }
                        if (g)try {
            ...
            function f(t, e, n) {
                ...
                return e.first ? function (e, n, r) {
                    ...
                    if (s) {
                        ...
                        if (l = e[q] || (e[q] = {}), (a = l[i]) && a[0] === W && a[1] === r)return c[2] = a[2];
            ...
            function v(t, e, n, o, r, s) {
                return o && !o[q] && (o = v(o)), r && !r[q] && (r = v(r, s)), i(function (i, s, a, l) {
                    var c, u, h, p = [], f = [], d = s.length, v = i || g(e || "*", a.nodeType ? [a] : a, []), y = !t || !i && e ? v : m(v, p, t, a, l), b = n ? r || (i ? t : d || o) ? [] : s : y;
                    ...
                    if (i) {
                        if (r || t) {
                            ...
                            for (u = b.length; u--;)(h = b[u]) && (c = r ? tt(i, h) : p[u]) > -1 && (i[c] = !(s[c] = h))
                        }
                    } else b = m(b === s ? b.splice(d, b.length) : b), r ? r(null, s, b, l) : G.apply(s, b)
                })
            }
            ...
            function y(t) {
                for (var e, n, i, o = t.length, r = T.relative[t[0].type], s = r || T.relative[" "], a = r ? 1 : 0, l = f(function (t) {
                    ...
                    return e = null, o
                }]; o > a; a++)if (n = T.relative[t[a].type])u = [f(d(u), n)]; else {
                    if (n = T.filter[t[a].type].apply(null, t[a].matches), n[q]) {
                        for (i = ++a; o > i && !T.relative[t[i].type]; i++);
                        return v(a > 1 && d(u), a > 1 && p(t.slice(0, a - 1).concat({value: " " === t[a - 2].type ? "*" : ""})).replace(lt, "$1"), n, i > a && y(t.slice(a, i)), o > i && y(t = t.slice(i)), o > i && p(t))
                    }
                    u.push(n)
                }
                return d(u)
            ...
            function b(t, n) {
                var o = n.length > 0, r = t.length > 0, s = function (i, s, a, l, c) {
                    var u, h, p, f = 0, d = "0", g = i && [], v = [], y = N, b = i || r && T.find.TAG("*", c), x = W += null == y ? 1 : Math.random() || .1, w = b.length;
                    for (c && (N = s !== O && s); d !== w && null != (u = b[d]); d++) {
                        if (r && u) {
                            for (h = 0; p = t[h++];)if (p(u, s, a)) {
                                l.push(u);
                                break
                            }
                            c && (W = x)
                    ...
                    if (f += d, o && d !== f) {
                        ...
                        if (i) {
                            if (f > 0)for (; d--;)g[d] || v[d] || (v[d] = J.call(l));
                            v = m(v)
                        }
            ...
            var x, w, T, C, $, k, E, S, N, D, A, j, O, I, L, R, P, F, H, q = "sizzle" + 1 * new Date, M = t.document, W = 0, B = 0, U = n(), _ = n(), z = n(), V = function (t, e) {
                return t === e && (A = !0), 0
            }, Q = 1 << 31, X = {}.hasOwnProperty, Y = [], J = Y.pop, K = Y.push, G = Y.push, Z = Y.slice, tt = function (t, e) {
                for (var n = 0, i = t.length; i > n; n++)if (t[n] === e)return n;
                return -1
            }, et = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", nt = "[\\x20\\t\\r\\n\\f]", it = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", ot = it.replace("w", "w#"), rt = "\\[" + nt + "*(" + it + ")(?:" + nt + "*([*^$|!~]?=)" + nt + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + ot + "))|)" + nt + "*\\]", st = ":(" + it + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + rt + ")*)|.*)\\)|)", at = new RegExp(nt + "+", "g"), lt = new RegExp("^" + nt + "+|((?:^|[^\\\\])(?:\\\\.)*)" + nt + "+$", "g"), ct = new RegExp("^" + nt + "*," + nt + "*"), ut = new RegExp("^" + nt + "*([>+~]|" + nt + ")" + nt + "*"), ht = new RegExp("=" + nt + "*([^\\]'\"]*?)" + nt + "*\\]", "g"), pt = new RegExp(st), ft = new RegExp("^" + ot + "$"), dt = {
                ID: new RegExp("^#(" + it + ")"),
                CLASS: new RegExp("^\\.(" + it + ")"),
            ...
            try {
                G.apply(Y = Z.call(M.childNodes), M.childNodes), Y[M.childNodes.length].nodeType
            } catch ($t) {
                G = {
            ...
            w = e.support = {}, $ = e.isXML = function (t) {
                ...
                return i !== O && 9 === i.nodeType && i.documentElement ? (O = i, I = i.documentElement, n = i.defaultView, n && n !== n.top && (n.addEventListener ? n.addEventListener("unload", Ct, !1) : n.attachEvent && n.attachEvent("onunload", Ct)), L = !$(i), w.attributes = o(function (t) {
                    ...
                    w.disconnectedMatch = F.call(t, "div"), F.call(t, "[s!='']:x"), P.push("!=", st)
                }), R = R.length && new RegExp(R.join("|")), P = P.length && new RegExp(P.join("|")), e = vt.test(I.compareDocumentPosition), H = e || vt.test(I.contains) ? function (t, e) {
                    ...
                    return n ? n : (n = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1, 1 & n || !w.sortDetached && e.compareDocumentPosition(t) === n ? t === i || t.ownerDocument === M && H(M, t) ? -1 : e === i || e.ownerDocument === M && H(M, e) ? 1 : D ? tt(D, t) - tt(D, e) : 0 : 4 & n ? -1 : 1)
                } : function (t, e) {
                    if (t === e)return A = !0, 0;
                ...
                if ((t.ownerDocument || t) !== O && j(t), n = n.replace(ht, "='$1']"), !(!w.matchesSelector || !L || P && P.test(n) || R && R.test(n)))try {
                    var i = F.call(t, n);
                ...
                return (t.ownerDocument || t) !== O && j(t), H(t, e)
            }, e.attr = function (t, e) {
                ...
                preFilter: {
                    ATTR: function (t) {
                        ...
                        var e, n = !t[6] && t[2];
                        return dt.CHILD.test(t[0]) ? null : (t[3] ? t[2] = t[4] || t[5] || "" : n && pt.test(n) && (e = k(n, !0)) && (e = n.indexOf(")", n.length - e) - n.length) && (t[0] = t[0].slice(0, e), t[2] = n.slice(0, e)), t.slice(0, 3))
                    }
                },
                filter: {
                    TAG: function (t) {
                        ...
                        return 1 === i && 0 === o ? function (t) {
                            ...
                            var c, u, h, p, f, d, g = r !== s ? "nextSibling" : "previousSibling", m = e.parentNode, v = a && e.nodeName.toLowerCase(), y = !l && !a;
                            if (m) {
                                if (r) {
                                    for (; g;) {
                                ...
                                if (d = [s ? m.firstChild : m.lastChild], s && y) {
                                    for (u = m[q] || (m[q] = {}), c = u[t] || [], f = c[0] === W && c[1], p = c[0] === W && c[2], h = f && m.childNodes[f]; h = ++f && h && h[g] || (p = f = 0) || d.pop();)if (1 === h.nodeType && ++p && h === e) {
                                        u[t] = [W, f, p];
                                        break
                                    }
                                } else if (y && (c = (e[q] || (e[q] = {}))[t]) && c[0] === W)p = c[1]; else for (; (h = ++f && h && h[g] || (p = f = 0) || d.pop()) && ((a ? h.nodeName.toLowerCase() !== v : 1 !== h.nodeType) || !++p || (y && ((h[q] || (h[q] = {}))[t] = [W, p]), h !== e)););
            ...
            return h.prototype = T.filters = T.pseudos, T.setFilters = new h, k = e.tokenize = function (t, n) {
                ...
                for (a = t, l = [], c = T.preFilter; a;) {
                    ...
                    for (s in T.filter)!(o = dt[s].exec(a)) || c[s] && !(o = c[s](o)) || (i = o.shift(), r.push({
                        value: i,
                        type: s,
                        matches: o
                    }), a = a.slice(i.length));
                ...
                var n, i = [], o = [], r = z[t + " "];
                if (!r) {
                    for (e || (e = k(t)), n = e.length; n--;)r = y(e[n]), r[q] ? i.push(r) : o.push(r);
                    r = z(t, b(o, i)), r.selector = t
                }
                return r
            }, S = e.select = function (t, e, n, i) {
                var o, r, s, a, l, c = "function" == typeof t && t, h = !i && k(t = c.selector || t);
                if (n = n || [], 1 === h.length) {
                    if (r = h[0] = h[0].slice(0), r.length > 2 && "ID" === (s = r[0]).type && w.getById && 9 === e.nodeType && L && T.relative[r[1].type]) {
                        if (e = (T.find.ID(s.matches[0].replace(wt, Tt), e) || [])[0], !e)return n;
                        c && (e = e.parentNode), t = t.slice(r.shift().value.length)
                    }
                    for (o = dt.needsContext.test(t) ? 0 : r.length; o-- && (s = r[o], !T.relative[a = s.type]);)if ((l = T.find[a]) && (i = l(s.matches[0].replace(wt, Tt), bt.test(r[0].type) && u(e.parentNode) || e))) {
                        if (r.splice(o, 1), t = i.length && p(r), !t)return G.apply(n, i), n;
                        break
                    }
                }
                return (c || E(t, h))(i, e, !L, n, bt.test(t) && u(e.parentNode) || e), n
            }, w.sortStable = q.split("").sort(V).join("") === q, w.detectDuplicates = !!A, j(), w.sortDetached = o(function (t) {
        ...
        var lt, ct = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/, ut = Z.fn.init = function (t, e) {
            ...
            if ("string" == typeof t) {
                ...
                if (n[1]) {
                    if (e = e instanceof Z ? e[0] : e, Z.merge(this, Z.parseHTML(n[1], e && e.nodeType ? e.ownerDocument || e : K, !0)), st.test(n[1]) && Z.isPlainObject(e))for (n in e)Z.isFunction(this[n]) ? this[n](e[n]) : this.attr(n, e[n]);
                    return this
                }
        ...
        ut.prototype = Z.fn, lt = Z(K);
        var ht = /^(?:parents|prev(?:Until|All))/, pt = {children: !0, contents: !0, next: !0, prev: !0};
        Z.extend({
            dir: function (t, e, n) {
            ...
            Z.fn[t] = function (n, i) {
                ...
                return "Until" !== t.slice(-5) && (i = n), i && "string" == typeof i && (o = Z.filter(i, o)), this.length > 1 && (pt[t] || Z.unique(o), ht.test(t) && o.reverse()), this.pushStack(o)
            }
        });
        var ft = /\S+/g, dt = {};
        ...
        Z.fn.ready = function (t) {
            ...
            return gt || (gt = Z.Deferred(), "complete" === K.readyState ? setTimeout(Z.ready) : (K.addEventListener("DOMContentLoaded", s, !1), t.addEventListener("load", s, !1))), gt.promise(e)
        }, Z.ready.promise();
        ...
        Z.event = {
            ...
            add: function (t, e, n, i, o) {
                var r, s, a, l, c, u, h, p, f, d, g, m = vt.get(t);
                ...
                }), e = (e || "").match(ft) || [""], c = e.length; c--;)a = Dt.exec(e[c]) || [], f = g = a[1], d = (a[2] || "").split(".").sort(), f && (h = Z.event.special[f] || {}, f = (o ? h.delegateType : h.bindType) || f, h = Z.event.special[f] || {}, u = Z.extend({
                    type: f,
                    origType: g,
                    data: i,
                    handler: n,
            ...
            remove: function (t, e, n, i, o) {
                var r, s, a, l, c, u, h, p, f, d, g, m = vt.hasData(t) && vt.get(t);
                if (m && (l = m.events)) {
                    for (e = (e || "").match(ft) || [""], c = e.length; c--;)if (a = Dt.exec(e[c]) || [], f = g = a[1], d = (a[2] || "").split(".").sort(), f) {
            ...
            trigger: function (e, n, i, o) {
                var r, s, a, l, c, u, h, p = [i || K], f = Y.call(e, "type") ? e.type : e, d = Y.call(e, "namespace") ? e.namespace.split(".") : [];
                if (s = a = i = i || K, 3 !== i.nodeType && 8 !== i.nodeType && !Nt.test(f + Z.event.triggered) && (f.indexOf(".") >= 0 && (d = f.split("."), f = d.shift(), d.sort()), c = f.indexOf(":") < 0 && "on" + f, e = e[Z.expando] ? e : new Z.Event(f, "object" == typeof e && e), e.isTrigger = o ? 2 : 3, e.namespace = d.join("."), e.namespace_re = e.namespace ? new RegExp("(^|\\.)" + d.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = i), n = null == n ? [e] : Z.makeArray(n, [e]), h = Z.event.special[f] || {}, o || !h.trigger || h.trigger.apply(i, n) !== !1)) {
                    ...
                    for (r = 0; (s = p[r++]) && !e.isPropagationStopped();)e.type = r > 1 ? l : h.bindType || f, u = (vt.get(s, "events") || {})[e.type] && vt.get(s, "handle"), u && u.apply(s, n), u = c && s[c], u && u.apply && Z.acceptData(s) && (e.result = u.apply(s, n), e.result === !1 && e.preventDefault());
        ...
        var At = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, jt = /<([\w:]+)/, Ot = /<|&#?\w+;/, It = /<(?:script|style|link)/i, Lt = /checked\s*(?:[^=]|=\s*.checked.)/i, Rt = /^$|\/(?:java|ecma)script/i, Pt = /^true\/(.*)/, Ft = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, Ht = {
        ...
        Ht.optgroup = Ht.option, Ht.tbody = Ht.tfoot = Ht.colgroup = Ht.caption = Ht.thead, Ht.th = Ht.td, Z.extend({
            clone: function (t, e, n) {
                ...
                if (!(J.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || Z.isXMLDoc(t)))for (s = v(a), r = v(t), i = 0, o = r.length; o > i; i++)y(r[i], s[i]);
                ...
                for (var o, r, s, a, l, c, u = e.createDocumentFragment(), h = [], p = 0, f = t.length; f > p; p++)if (o = t[p], o || 0 === o)if ("object" === Z.type(o))Z.merge(h, o.nodeType ? [o] : o); else if (Ot.test(o)) {
                    for (r = r || u.appendChild(e.createElement("div")), s = (jt.exec(o) || ["", ""])[1].toLowerCase(), a = Ht[s] || Ht._default, r.innerHTML = a[1] + o.replace(At, "<$1></$2>") + a[2], c = a[0]; c--;)r = r.lastChild;
                    Z.merge(h, r.childNodes), r = u.firstChild, r.textContent = ""
                } else h.push(e.createTextNode(o));
                for (u.textContent = "", p = 0; o = h[p++];)if ((!i || -1 === Z.inArray(o, i)) && (l = Z.contains(o.ownerDocument, o), r = v(u.appendChild(o), "script"), l && g(r), n))for (c = 0; o = r[c++];)Rt.test(o.type || "") && n.push(o);
                return u
            ...
            text: function (t) {
                ...
                return mt(this, function (t) {
                    ...
                    if ("string" == typeof t && !It.test(t) && !Ht[(jt.exec(t) || ["", ""])[1].toLowerCase()]) {
                        t = t.replace(At, "<$1></$2>");
                        try {
                ...
                t = _.apply([], t);
                var n, i, o, r, s, a, l = 0, c = this.length, u = this, h = c - 1, p = t[0], g = Z.isFunction(p);
                if (g || c > 1 && "string" == typeof p && !J.checkClone && Lt.test(p))return this.each(function (n) {
                    var i = u.eq(n);
                ...
                if (c && (n = Z.buildFragment(t, this[0].ownerDocument, !1, this), i = n.firstChild, 1 === n.childNodes.length && (n = i), i)) {
                    ...
                    if (r)for (a = o[o.length - 1].ownerDocument, Z.map(o, d), l = 0; r > l; l++)s = o[l], Rt.test(s.type || "") && !vt.access(s, "globalEval") && Z.contains(a, s) && (s.src ? Z._evalUrl && Z._evalUrl(s.src) : Z.globalEval(s.textContent.replace(Ft, "")))
                }
                return this
            }
        }), Z.each({
        ...
        var qt, Mt = {}, Wt = /^margin/, Bt = new RegExp("^(" + wt + ")(?!px)[a-z%]+$", "i"), Ut = function (e) {
        ...
        !function () {
            ...
            s.style && (s.style.backgroundClip = "content-box", s.cloneNode(!0).style.backgroundClip = "", J.clearCloneStyle = "content-box" === s.style.backgroundClip, r.style.cssText = "border:0;width:0;height:0;top:0;left:-9999px;margin-top:1px;position:absolute", r.appendChild(s), t.getComputedStyle && Z.extend(J, {
        ...
        var _t = /^(none|table(?!-c[ea]).+)/, zt = new RegExp("^(" + wt + ")(.*)$", "i"), Vt = new RegExp("^([+-])=(" + wt + ")", "i"), Qt = {
            position: "absolute",
            visibility: "hidden",
            display: "block"
        ...
        Z.extend({
            ...
            Z.cssHooks[e] = {
                get: function (t, n, i) {
                    return n ? _t.test(Z.css(t, "display")) && 0 === t.offsetWidth ? Z.swap(t, Qt, function () {
                        return E(t, e, i)
                    }) : E(t, e, i) : void 0
                }, set: function (t, n, i) {
                    var o = i && Ut(t);
                    return $(t, n, i ? k(t, e, i, "border-box" === Z.css(t, "boxSizing", !1, o), o) : 0)
                }
            }
        ...
        var Jt, Kt, Gt = /^(?:toggle|show|hide)$/, Zt = new RegExp("^(?:([+-])=|)(" + wt + ")([a-z%]*)$", "i"), te = /queueHooks$/, ee = [O], ne = {
            "*": [function (t, e) {
        ...
        Z.Animation = Z.extend(L, {
            ...
            for (Jt = Z.now(); e < n.length; e++)t = n[e], t() || n[e] !== t || n.splice(e--, 1);
        ...
        Z.fn.extend({
            ...
            valHooks: {
                option: {
                    ...
                    get: function (t) {
                        for (var e, n, i = t.options, o = t.selectedIndex, r = "select-one" === t.type || 0 > o, s = r ? null : [], a = r ? o + 1 : i.length, l = 0 > o ? a : r ? o : 0; a > l; l++)if (n = i[l], !(!n.selected && l !== o || (J.optDisabled ? n.disabled : null !== n.getAttribute("disabled")) || n.parentNode.disabled && Z.nodeName(n.parentNode, "optgroup"))) {
        ...
        var he = /#.*$/, pe = /([?&])_=[^&]*/, fe = /^(.*?):[ \t]*([^\r\n]*)$/gm, de = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, ge = /^(?:GET|HEAD)$/, me = /^\/\//, ve = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/, ye = {}, be = {}, xe = "*/".concat("*"), we = t.location.href, Te = ve.exec(we.toLowerCase()) || [];
        Z.extend({
            active: 0,
            lastModified: {},
            etag: {},
            ...
            ajax: function (t, e) {
                function n(t, e, n, s) {
                    var l, u, v, y, x, T = e;
                    2 !== b && (b = 2, a && clearTimeout(a), i = void 0, r = s || "", w.readyState = t > 0 ? 4 : 0, l = t >= 200 && 300 > t || 304 === t, n && (y = H(h, w, n)), y = q(h, y, w, l), l ? (h.ifModified && (x = w.getResponseHeader("Last-Modified"), x && (Z.lastModified[o] = x), x = w.getResponseHeader("etag"), x && (Z.etag[o] = x)), 204 === t || "HEAD" === h.type ? T = "nocontent" : 304 === t ? T = "notmodified" : (T = y.state, u = y.data, v = y.error, l = !v)) : (v = T, (t || !T) && (T = "error", 0 > t && (t = 0))), w.status = t, w.statusText = (e || T) + "", l ? d.resolveWith(p, [u, T, w]) : d.rejectWith(p, [w, T, v]), w.statusCode(m), m = void 0, c && f.trigger(l ? "ajaxSuccess" : "ajaxError", [w, h, l ? u : v]), g.fireWith(p, [w, T]), c && (f.trigger("ajaxComplete", [w, h]), --Z.active || Z.event.trigger("ajaxStop")))
                }

                "object" == typeof t && (e = t, t = void 0), e = e || {};
                var i, o, r, s, a, l, c, u, h = Z.ajaxSetup({}, e), p = h.context || h, f = h.context && (p.nodeType || p.jquery) ? Z(p) : Z.event, d = Z.Deferred(), g = Z.Callbacks("once memory"), m = h.statusCode || {}, v = {}, y = {}, b = 0, x = "canceled", w = {
                    readyState: 0,
        ...
        Z.param = function (t, e) {
            ...
            serialize: function () {
                ...
                return this.map(function () {
                    ...
                    var t = this.type;
                    return this.name && !Z(this).is(":disabled") && Se.test(this.nodeName) && !Ee.test(t) && (this.checked || !$t.test(t))
                }).map(function (t, e) {
                    var n = Z(this).val();
        ...
        Z.offset = {
            ...
            Z.cssHooks[e] = T(J.pixelPosition, function (t, n) {
        ...
        var Pe = t.jQuery, Fe = t.$;
        return Z.noConflict = function (e) {
            return t.$ === Z && (t.$ = Fe), e && t.jQuery === Z && (t.jQuery = Pe), Z
...
if (+function (t) {
        ...
        n.VERSION = "3.3.5", n.TRANSITION_DURATION = 150, n.DEFAULTS = {
            ...
            if (this.hasContent() && this.enabled) {
                ...
                var u = this.getPosition(), h = r[0].offsetWidth, p = r[0].offsetHeight;
                if (c) {
                    var f = a, d = this.getPosition(this.$viewport);
                    a = "bottom" == a && u.bottom + p > d.bottom ? "top" : "top" == a && u.top - p < d.top ? "bottom" : "right" == a && u.right + h > d.width ? "left" : "left" == a && u.left - h < d.left ? "right" : a, r.removeClass(f).addClass(a)
                }
            ...
            var h = /top|bottom/.test(n), p = h ? 2 * u.left - o + l : 2 * u.top - r + c, f = h ? "offsetWidth" : "offsetHeight";
