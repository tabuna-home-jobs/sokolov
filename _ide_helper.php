 ...
 * Generated for Laravel 5.1.12 (LTS) on 2015-09-08.
 *
...
namespace {
    ...
    class SMS extends \App\Facades\IntisSMSFacades
    {
        ...
        {
            return \App\Services\IntisSMS::init();
        }
        ...
        {
            return \App\Services\IntisSMS::balance();
        }
        ...
        {
            return \App\Services\IntisSMS::send($number, $text);
        }
        ...
        {
            return \App\Services\IntisSMS::status($id);
        }
         ...
         * @static
         */
        public static function statistic($data = null)
        {
            return \App\Services\IntisSMS::statistic($data);
        }
